...
class SentimentAnalyzer:
    ...
    def analyze_quick(
        ...
        try:
            ...
            return [{'normalized_score': 0.0, 'label': 'NEUTRAL', 'confidence': 0.0}] * len(texts)
    ...
    def analyze_detailed(
        ...
        try:
            ...
            return {
                'general': {'normalized_score': 0.0, 'label': 'NEUTRAL', 'confidence': 0.0},
                'aspects': {aspect: {'normalized_score': 0.0, 'label': 'NEUTRAL', 'confidence': 0.0} for aspect in aspects}
            }
