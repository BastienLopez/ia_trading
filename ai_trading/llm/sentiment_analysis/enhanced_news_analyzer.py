...
class EnhancedNewsAnalyzer(NewsAnalyzer):
    ...
    def __init__(self, enable_cache: bool = True, cache_dir: str = "data/sentiment/cache", **kwargs):
    ...
    def generate_report(self, df: pd.DataFrame) -> Dict:
        ...
        report = {
            ...
            'sentiment_distribution': df['global_sentiment_label'].value_counts().to_dict() if 'global_sentiment_label' in df.columns else {},
