...
class PredictionExplainer:
    ...
    def __init__(self, prediction_model=None, market_data: Optional[pd.DataFrame] = None):
        ...
        logger.info(f"PredictionExplainer initialisé avec un modèle de type: {self.model_type}")
    ...
    def _explain_llm_prediction(self, prediction: Dict[str, Any]) -> Dict[str, Any]:
        ...
        explanation = {
            ...
            "factor_confidence": {factor: 1.0/len(factors) for factor in factors} if factors else {},
            "prediction_id": prediction.get("id", "unknown"),
            "asset": prediction.get("asset", "unknown"),
            "direction": prediction.get("direction", "unknown"),
            "timestamp": datetime.now().isoformat(),
    ...
    def generate_report(self, 
        ...
        """
        logger.info(f"Génération de rapport d'interprétabilité pour {prediction.get('asset', 'unknown')}")
        ...
        report["comparative_analysis"] = self._compare_explanations(report["explanations"])
    ...
    def plot_shap_summary(self, prediction_id: Optional[str] = None, save_path: Optional[str] = None):
        """
        ...
        plt.title(f"SHAP Feature Importance pour {shap_explanation.get('asset', 'Unknown')}")
        plt.tight_layout()
    ...
    def plot_lime_explanation(self, prediction_id: Optional[str] = None, save_path: Optional[str] = None):
        """
    ...
    def plot_factor_importance(self, prediction: Dict[str, Any], save_path: Optional[str] = None):
        """
