...
from .async_blockchain_collector import AsyncBlockchainCollector
...
class EnhancedBlockchainCollector(AsyncBlockchainCollector):
    ...
    def __init__(
        ...
        logger.info(
            f"Collecteur blockchain amélioré initialisé avec Redis {'Cluster' if use_cluster else 'Standard'}"
        )
    ...
    async def _prefetch_related_data(
        self, session, source: str, data: Dict, params: Dict
    ):
        """
        ...
        for related_type in related_types:
            try:
                ...
                related_params = self._build_related_params(
                    data_type, related_type, params, data
                )
                if related_params:
    ...
    def _build_related_params(
        self, data_type: str, related_type: str, original_params: Dict, data: Dict
    ) -> Optional[Dict]:
        """
