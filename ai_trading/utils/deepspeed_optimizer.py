...
try:
    ...
    logger.warning("DeepSpeed n'est pas installé. Utilisez 'pip install deepspeed' pour l'installer.")
...
class DeepSpeedOptimizer:
    ...
    def __init__(
        ...
        if not HAVE_DEEPSPEED:
            raise ImportError("DeepSpeed n'est pas installé. Utilisez 'pip install deepspeed' pour l'installer.")
...
def create_deepspeed_config(
    ...
    Args:
        ...
        offload_optimizer: Si True, décharge l'état de l'optimiseur sur le CPU.
        offload_parameters: Si True, décharge les paramètres sur le CPU.
        output_file: Chemin du fichier de sortie (si None, retourne seulement le dictionnaire).
