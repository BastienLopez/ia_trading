...
def generate_mock_market_data(days=100):
    ...
    data = pd.DataFrame({
        ...
        'direction_code': np.random.choice([0, 1, 2], days)  # 0=bearish, 1=neutral, 2=bullish
    })
...
class TestMultiHorizonPredictor:
    ...
    def test_short_term_predictions(self):
        ...
        # Appliquer les mocks
        self.predictor.initialize_prediction_models = types.MethodType(mock_initialize, self.predictor)
    ...
    def test_all_time_horizons(self):
        ...
        # Vérifications
        all_timeframes = self.predictor.SHORT_TERM + self.predictor.MEDIUM_TERM + self.predictor.LONG_TERM
    ...
    def test_consistency_analysis(self):
        ...
        for i, timeframe in enumerate(self.predictor.MEDIUM_TERM):
            direction = "bullish" if i < len(self.predictor.MEDIUM_TERM) // 2 else "neutral"
            confidence = "medium"
            all_predictions[timeframe] = {
                "direction": direction,
        ...
        assert consistency_analysis["horizon_analysis"]["short_term"]["overall_direction"] == "bullish"
        assert consistency_analysis["horizon_analysis"]["long_term"]["overall_direction"] == "bearish"
    ...
    def test_trading_signals(self):
        ...
        bullish_analysis = {
            "short_term": {"overall_direction": "bullish", "consistency": 0.9, "confidence": "high"},
            "medium_term": {"overall_direction": "bullish", "consistency": 0.8, "confidence": "medium"},
            "long_term": {"overall_direction": "bullish", "consistency": 0.75, "confidence": "medium"}
        }
        ...
        bearish_analysis = {
            "short_term": {"overall_direction": "bearish", "consistency": 0.8, "confidence": "medium"},
            "medium_term": {"overall_direction": "bearish", "consistency": 0.7, "confidence": "low"},
            "long_term": {"overall_direction": "neutral", "consistency": 0.6, "confidence": "low"}
        }
        ...
        reversal_analysis = {
            "short_term": {"overall_direction": "bearish", "consistency": 0.7, "confidence": "medium"},
            "medium_term": {"overall_direction": "neutral", "consistency": 0.5, "confidence": "low"},
            "long_term": {"overall_direction": "bullish", "consistency": 0.8, "confidence": "medium"}
        }
