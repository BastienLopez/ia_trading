...
class MockRTXOptimizer:
    def __init__(
        ...
        self.gpu_model = (
            "NVIDIA GeForce RTX 3070"  # Modifié pour correspondre au GPU réel
        )
...
class TestMarketPredictorWithRTX(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patches.append(
            patch(
                "ai_trading.llm.predictions.rtx_optimizer.RTXOptimizer",
                MockRTXOptimizer,
            )
        )
        ...
        self.patches.append(
            patch(
                "ai_trading.llm.predictions.rtx_optimizer.detect_rtx_gpu",
                return_value=rtx_info,
            )
        )
        ...
        self.patches.append(
            patch(
                "ai_trading.llm.predictions.rtx_optimizer.setup_rtx_environment",
                return_value=True,
            )
        )
    ...
    def test_rtx_initialization(self):
        ...
        self.assertEqual(
            self.predictor.rtx_optimizer.gpu_model, "NVIDIA GeForce RTX 3070"
        )
    ...
    def test_prediction_with_rtx(self):
        ...
        self.assertEqual(
            prediction["gpu_info"]["gpu_model"], "NVIDIA GeForce RTX 3070"
        )  # Modifié
...
class TestPredictionModelWithRTX(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patches.append(
            patch("ai_trading.llm.predictions.market_predictor.MarketPredictor")
        )
        ...
        self.patches.append(
            patch(
                "ai_trading.llm.predictions.prediction_model.EnsembleParallelProcessor",
        ...
        self.model.torch_models = [MagicMock(), MagicMock()]
...
class TestTensorRTOptimization(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patches.append(
            patch("ai_trading.llm.predictions.rtx_optimizer.HAS_TENSORRT", True)
        )
