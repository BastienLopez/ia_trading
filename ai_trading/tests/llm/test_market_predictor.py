...
class TestMarketPredictor(unittest.TestCase):
    ...
    def test_predict_market_direction(self):
        ...
        prediction = self.predictor.predict_market_direction(
            asset="BTC", timeframe="24h", market_data=market_data
        )
    ...
    def test_get_confidence_score(self):
        ...
        aligned_prediction = {"direction": "bullish", "sentiment_score": 0.6}
        ...
        misaligned_prediction = {"direction": "bullish", "sentiment_score": -0.4}
        ...
        bearish_prediction = {"direction": "bearish", "sentiment_score": -0.7}
    ...
    def test_format_prompt(self):
        ...
        self.assertTrue(
            "0.65" in prompt_repr or "0,65" in prompt_repr,
            f"Le score de sentiment 0.65 n'est pas trouvé dans: {prompt_repr}",
        )
        self.assertTrue(
            "0.72" in prompt_repr or "0,72" in prompt_repr,
            f"Le score de sentiment 0.72 n'est pas trouvé dans: {prompt_repr}",
        )
