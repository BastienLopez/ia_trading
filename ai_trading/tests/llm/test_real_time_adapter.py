...
from ai_trading.tests.llm.utils.mock_real_time_adapter import mock_real_time_adapter_predictor, patch_real_time_adapter
...
class TestRealTimeAdapter(unittest.TestCase):
    ...
    def test_add_data_and_process(self):
        ...
        market_data = {'price': 105.0, 'volume': 100.0, 'trend': 'bullish', 'asset': 'BTC'}
        ...
        self.assertEqual(2, self.update_callback.call_count, "Le callback update doit être appelé exactement deux fois")
    ...
    def test_significant_change_detection(self):
        ...
        self.assertEqual(2, self.update_callback.call_count, "Le callback update doit être appelé exactement deux fois")
        self.assertEqual(2, self.change_callback.call_count, "Le callback change doit être appelé exactement deux fois")
...
class TestRealTimeMarketMonitor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.monitor.set_alert_callback('significant_price_move', self.price_move_callback)
