...
class TestCompressedStorage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.storage = CompressedStorage(compression_level=9)  # Niveau plus élevé pour les tests
        
        # Créer des données de test
        self.text_data = "Hello, world! " * 1000
        self.binary_data = os.urandom(100000)  # Augmenter la taille pour une meilleure compression
    ...
    def test_read_compressed_chunks(self):
        ...
        with open(test_file, 'w') as f:
            f.write("This is a test file with repetitive content for chunked reading. " * 1000)
        ...
        chunks = []
        for chunk in self.storage.read_compressed_chunks(compressed_file, chunk_size=1000):
            chunks.append(chunk)
    ...
    def test_stream_dataframe_chunks(self):
        ...
        chunks = []
        for chunk in self.storage.stream_dataframe_chunks(df_file, format='csv', chunksize=1000):
            chunks.append(chunk)
    ...
    def test_compression_dictionary(self):
        ...
        dict_storage = CompressedStorage(compression_level=3, use_dict=True, dict_size=50000)
    ...
    def test_utility_functions(self):
        ...
        compressible_data = ("This is a highly compressible string. " * 100).encode('utf-8')
        optimal_level, results = optimize_compression_level(compressible_data, test_levels=[1, 3])
