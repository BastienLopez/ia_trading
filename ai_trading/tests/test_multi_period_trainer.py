...
import ai_trading.rl.agents as agents
import pytest
...
class TestMultiPeriodTrainer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_collector_patcher = patch('ai_trading.rl.multi_period_trainer.EnhancedMarketDataCollector')
        ...
        self.mock_integrator_patcher = patch('ai_trading.rl.multi_period_trainer.EnhancedSentimentCollector')
        ...
        self.mock_env_patcher = patch('ai_trading.rl.multi_period_trainer.TradingEnvironment')
        ...
        self.mock_multi_env_patcher = patch('ai_trading.rl.multi_period_trainer.MultiEnvTrading')
    ...
    def test_initialization(self, mock_gru_agent, mock_sac_agent, mock_env, mock_sentiment, mock_market):
        # Configure mocks
        ...
        mock_sentiment_instance.collect_sentiment_data.return_value = self.sentiment_data
    ...
    def test_collect_data(self, mock_sentiment_collector, mock_market_collector):
        ...
        mock_sentiment_data = pd.DataFrame({
            ...
            'sentiment_magnitude': [0.8, 0.9, 1.0]
        })
    ...
    def test_create_env(self, mock_env, mock_sentiment_collector, mock_market_collector):
    ...
    @patch('ai_trading.rl.multi_period_trainer.EnhancedSentimentCollector')
    @patch('ai_trading.rl.multi_period_trainer.MultiEnvTrading')
    @pytest.mark.skip(reason="Paramètres incompatibles entre les agents SACAgent et NStepSACAgent")
    def test_create_agent(self, mock_env, mock_sentiment_collector, mock_market_collector):
    ...
    def test_prepare_datasets(self, mock_sentiment_collector, mock_market_collector):
        ...
        train_market, train_sentiment, val_market, val_sentiment = trainer.prepare_datasets(
    ...
    def test_train_period(self, mock_exists, mock_env_class):
        ...
        mock_env.step.return_value = (np.zeros(20), 1.0, False, False, {})  # résultat de step factice
    ...
    def test_train_all_periods(self):
        ...
        self.trainer.train_period = MagicMock(return_value={
            'train_rewards': [0.1, 0.2],
            'val_rewards': [0.05, 0.15]
        })
    ...
    def test_evaluate(self):
        ...
        self.mock_env_instance.reset.return_value = (np.zeros(20), {})  # état initial factice
        self.mock_env_instance.step.return_value = (np.zeros(20), 1.0, False, False, {})  # résultat de step factice
