...
class TestVolumeAnalyzer(unittest.TestCase):
    ...
    def test_create_volume_profile_price(self):
        ...
        self.assertTrue(self.data['low'].min() <= profile['max_volume_price'] <= self.data['high'].max())
    ...
    def test_detect_volume_anomalies(self):
        ...
        self.assertTrue(25 in anomalies.index or 50 in anomalies.index or 75 in anomalies.index)
        
    def test_calculate_volume_price_correlation(self):
        """Teste le calcul de la corrélation volume/prix."""
        correlation = self.analyzer.calculate_volume_price_correlation(
            window_size=15
        )
    ...
    def test_validate_signal(self):
        ...
        validation = self.analyzer.validate_signal(
