...
evenements_reglementaires = detecteur.detect_regulatory_events(nouvelles_preprocessees, threshold=0.05)
...
evenements_fondamentaux = detecteur.detect_fundamental_events(nouvelles_preprocessees, threshold=0.05)
...
changements_narratif = detecteur.detect_narrative_changes(nouvelles_preprocessees, min_mentions=1)
