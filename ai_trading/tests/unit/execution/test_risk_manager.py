...
def test_drawdown_control():
    ...
    assert metrics["is_max_drawdown_breached"] is True  # Maintenant le drawdown dépasse la limite
...
def test_exposure_manager():
    ...
    assert position_size <= 100000.0 * (config.max_position_size / 100) * exposure_manager.market_exposure
