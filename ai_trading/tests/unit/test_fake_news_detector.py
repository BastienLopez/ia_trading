...
class TestFakeNewsDetector(unittest.TestCase):
    def setUp(self):
        ...
        self.sample_news_content = "Bitcoin atteint un nouveau record historique selon des experts."
    ...
    def test_credibility_score_with_obvious_fake(self):
        fake_news_content = "URGENT: Tous les exchanges crypto ferment définitivement!!!"
        ...
        self.assertLess(score, 0.3)  # Score devrait être bas pour une fake news évidente
