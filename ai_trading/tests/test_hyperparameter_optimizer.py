...
class TestHyperparameterOptimizer(unittest.TestCase):
    ...
    @patch('ai_trading.rl.hyperparameter_optimizer.HyperparameterOptimizer._evaluate_params')
    def test_optimize_sac_agent(self, mock_evaluate_params):
        ...
        mock_evaluate_params.return_value = (0.75, self.minimal_param_grid, {'train_avg_reward': 10.0})
    ...
    @patch('ai_trading.rl.hyperparameter_optimizer.HyperparameterOptimizer._evaluate_agent', mock_evaluate_agent)
    @patch('ai_trading.rl.hyperparameter_optimizer.HyperparameterOptimizer._calculate_score')
    def test_evaluate_params_with_mock(self, mock_calculate_score):
        ...
        with patch.object(HyperparameterOptimizer, '_train_agent', return_value={'reward': 0.5, 'sharpe': 0.75}):
            ...
            params_dict = {'actor_learning_rate': [0.001], 'critic_learning_rate': [0.001], 'batch_size': [64], 'hidden_size': [128]}
            score, returned_params, metrics = optimizer._evaluate_params(params_dict, 0, 1)
