...
class TestCurriculumLearning(unittest.TestCase):
    ...
    def test_init_and_difficulty_levels(self):
        ...
        self.assertEqual(sorted(list(self.curriculum.difficulty_levels.keys())), expected_levels)
    ...
    def test_generate_params_for_difficulty(self):
        ...
        self.assertEqual(easy_params["reward_function"], "simple")  # Facile: récompense simple
        self.assertEqual(hard_params["reward_function"], "drawdown")  # Difficile: récompense avec drawdown
    ...
    def test_get_longest_consecutive_segment(self):
        ...
        df_dates = pd.DataFrame({
            'value': range(len(non_consecutive_dates))
        }, index=non_consecutive_dates)
    ...
    def test_update_difficulty(self):
        ...
        self.assertEqual(self.curriculum.success_streak, 0)  # Réinitialisé après augmentation
    ...
    def test_create_environment(self):
        ...
        self.assertEqual(env.initial_balance, level_params.get("initial_balance", 10000.0))
