...
class TestNStepReplayBuffer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.buffer = NStepReplayBuffer(
            buffer_size=self.buffer_size, n_steps=self.n_steps, gamma=self.gamma
        )
    ...
    def test_n_step_return_calculation(self):
        ...
        rewards = [
            ...
            2.0,
            3.0,
        ]  # Récompenses croissantes pour faciliter la vérification
        ...
        expected_reward = (
            rewards[0] + self.gamma * rewards[1] + (self.gamma**2) * rewards[2]
        )
    ...
    def test_early_termination(self):
        ...
        expected_reward = (
            rewards[0] + self.gamma * rewards[1]
        )  # Seulement 2 récompenses car l'épisode se termine
    ...
    def test_handle_episode_end(self):
        ...
        states = [
            np.random.random(self.state_size) for _ in range(2)
        ]  # Seulement 2 expériences
