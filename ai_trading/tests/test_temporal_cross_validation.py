...
class TestTemporalCrossValidation(unittest.TestCase):
    ...
    def test_temporal_cross_validator_initialization(self):
        ...
        cv = TemporalCrossValidator(
            data=self.df, n_splits=5, initial_train_size=0.6, gap=1
        )
    ...
    def test_temporal_cross_validator_split(self):
        ...
        cv = TemporalCrossValidator(
            data=self.df, n_splits=3, initial_train_size=0.5, gap=2
        )
    ...
    def test_temporal_cross_validator_evaluate(self):
        ...
        cv = TemporalCrossValidator(
            data=self.df, n_splits=3, initial_train_size=0.5, gap=1
        )
    ...
    def test_walk_forward_optimizer_initialization(self):
        ...
        param_grid = {"window_size": [5, 10, 20], "alpha": [0.01, 0.1]}
    ...
    def test_walk_forward_optimizer_optimize(self):
        ...
        param_grid = {"window_size": [5, 10], "alpha": [0.1, 0.5]}
        ...
        for i in range(len(all_results) - 1):
            self.assertGreaterEqual(
                all_results[i]["avg_val_metric"], all_results[i + 1]["avg_val_metric"]
            )
    ...
    def test_visualization(self):
        ...
        cv = TemporalCrossValidator(
            data=self.df, n_splits=3, initial_train_size=0.5, gap=5
        )
