...
class TestRiskManager(unittest.TestCase):
    ...
    def test_calculate_atr_stop_loss(self):
        ...
        self.assertEqual(
            self.risk_manager.position_stops["test_position"]["stop_loss"], stop_loss
        )
    ...
    def test_calculate_atr_take_profit(self):
        ...
        self.assertIn("test_position", self.risk_manager.position_stops)
        self.assertEqual(
            self.risk_manager.position_stops["test_position"]["take_profit"],
            take_profit,
        )
