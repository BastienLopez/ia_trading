...
class TestMixedPrecision(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.mp_supported = is_mixed_precision_supported() if cls.cuda_available else False
    ...
    def test_performance_test_function(self):
        ...
        expected_keys = [
            "fp32_time", "fp16_time", "speedup", 
            "fp32_memory_mb", "fp16_memory_mb", "memory_reduction"
        ]
