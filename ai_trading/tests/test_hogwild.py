...
from rl.hogwild import HogwildWorker, HogwildTrainer, AsyncAdvantageActorCritic, a3c_loss_fn
...
class TestHogwild(unittest.TestCase):
    ...
    def test_a3c_model(self):
        ...
        self.assertIsInstance(model.policy_head, nn.Linear)  # Utiliser le nom correct: policy_head
        self.assertIsInstance(model.value_head, nn.Linear)   # Utiliser le nom correct: value_head
