...
class TestRayRLlibOptimizer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.algorithm_mock.save.return_value = os.path.join(
    ...
    def test_evaluate(self, mock_register_env, mock_ray_init):
        ...
        # Créer l'optimiseur
        optimizer = RayRLlibOptimizer(
            env_creator=env_creator_mock, algorithm="PPO", num_workers=1
        )
    ...
    def test_save_load_model(self, mock_register_env, mock_ray_init):
        ...
        # Créer l'optimiseur
        optimizer = RayRLlibOptimizer(
            env_creator=self.env_creator, algorithm="PPO", num_workers=1
        )
...
class TestOptimizeRLWithRay(unittest.TestCase):
    ...
    def test_optimize_rl_with_ray(self, mock_register_env, mock_ray_init):
        ...
        with patch(
            "ai_trading.utils.ray_rllib_optimizer.RayRLlibOptimizer",
            return_value=optimizer_mock,
        ):
