...
class TestEfficientCheckpointing(unittest.TestCase):
    ...
    def test_compare_checkpoint_sizes(self):
        ...
        self.assertGreaterEqual(
            ...
            result["model_only_mb"] + result["optimizer_only_mb"] - 0.1  # Marge d'erreur
        )
    ...
    def test_checkpoint_manager_basic(self):
        ...
        checkpoint_epochs = [int(path.stem.split('_')[-1]) for path in checkpoint_mgr.checkpoints]
    ...
    def test_restore_model(self):
        ...
        original_optimizer_state = {
            ...
            for group_idx, group in enumerate(self.optimizer.state_dict()["param_groups"])
        }
        ...
        for name, param in self.model.named_parameters():
            ...
            self.assertFalse(torch.allclose(original_param, param), 
    ...
    def test_weights_only_mode(self):
        ...
        if isinstance(checkpoint, dict) and 'optimizer_state_dict' in checkpoint:
            self.fail("Le checkpoint en mode weights_only contient l'état de l'optimiseur")
