...
class SimpleDuelingDQNAgent(SimpleDQNAgent):
    ...
    def __init__(self, state_size, action_size):
        ...
        print(
            f"Dueling DQN initialisé avec {state_size} variables d'état et {action_size} actions"
        )
...
if __name__ == "__main__":
    ...
    print(
        "Pour un test complet avec TensorFlow et entraînement, exécutez test_simple_dqn.py"
    )
