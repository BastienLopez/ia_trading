...
class AdaptiveExecutor:
    ...
    def execute(
        ...
        """
        logger.info(
            f"Exécution d'ordre: {symbol} {side} {quantity} avec mode {mode.value}"
        )
    ...
    def suggest_execution_mode(
        self, symbol: str, quantity: float, side: str, urgency: float = 0.5
    ) -> ExecutionMode:
        """
