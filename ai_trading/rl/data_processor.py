...
def prepare_data_for_rl(market_data, sentiment_data=None, window_size=5, test_split=0.2):
    """
    ...
    logger.info(f"Données préparées: {len(train_data)} points d'entraînement, {len(test_data)} points de test")
