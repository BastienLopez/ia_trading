...
class AdvancedRewardCalculator:
    ...
    def __init__(
        ...
        logger.info(
            f"Calculateur de récompenses avancées initialisé: "
    ...
    def calculate_combined_reward(self, portfolio_value, action, position_size):
        ...
        transaction_penalty = self.calculate_transaction_cost_penalty(
        ...
        logger.debug(
            f"Récompense Sharpe: {sharpe_reward:.4f}, "
