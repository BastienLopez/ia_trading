...
LOG_DIR = Path(__file__).parent.parent / "info_retour" / "logs" / "gradient_accumulation"
MODEL_DIR = Path(__file__).parent.parent / "info_retour" / "models" / "gradient_accumulation"
