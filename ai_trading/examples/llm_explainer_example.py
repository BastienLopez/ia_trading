...
def main():
    ...
    predictions = {
        "short_term": {**prediction, "timeframe": "4h", "direction": "neutral"},
    ...
    explainer.plot_factor_importance(
        prediction, os.path.join(output_dir, "factor_importance.png")
    )
    ...
    dashboard_path = visualizer.create_prediction_dashboard(
        predictions, market_data, os.path.join(output_dir, "prediction_dashboard.html")
    )
