...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Exemple d'optimisation bayésienne des hyperparamètres"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="BTC",
        help="Symbole pour le nom des fichiers de résultats",
    )
    parser.add_argument(
        "--agent",
        type=str,
...
def main():
    ...
    if args.multi_objective:
        ...
        logger.info(
            f"Optimisation multi-objectifs activée avec les poids: {multi_objective_weights}"
        )
