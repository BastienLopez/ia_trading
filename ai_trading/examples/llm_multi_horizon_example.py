...
def main():
    ...
    predictor = MultiHorizonPredictor(
        llm_model="gpt-4", 
        use_hybrid=False  # Utiliser uniquement LLM pour cet exemple
    )
    ...
    print(f"  Directions: court={signal['short_term_dir']}, moyen={signal['medium_term_dir']}, long={signal['long_term_dir']}")
