...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Exemple d'entraînement multi-période pour le trading RL")
    
    parser.add_argument('--symbol', type=str, default='BTC',
                       help='Symbole de la crypto-monnaie (ex: BTC, ETH)')
    parser.add_argument('--days', type=int, default=60,
                       help='Nombre de jours de données historiques à collecter')
    parser.add_argument('--periods', type=str, default='1440,240,60',
    ...
    parser.add_argument('--no_sentiment', dest='include_sentiment', action='store_false',
                       help='Ne pas inclure les données de sentiment')
    parser.add_argument('--epochs', type=int, default=5,
                       help='Nombre d\'époques par période')
    parser.add_argument('--episodes', type=int, default=5,
                       help='Nombre d\'épisodes par époque')
    ...
    parser.add_argument('--action_type', type=str, default='continuous', choices=['continuous', 'discrete'],
                       help='Type d\'espace d\'action (continuous ou discrete)')
    parser.add_argument('--test', action='store_true',
                       help='Évaluer l\'agent final après l\'entraînement')
...
def main():
    ...
    if args.test:
        ...
        logger.info(f"Valeur finale du portefeuille: ${test_results['portfolio_value']:.2f}")
