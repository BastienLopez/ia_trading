...
def main():
    ...
    for i, news in enumerate(enriched_news):
        ...
        print(f"Sentiment du titre: {news['title_sentiment']['label']} ({news['title_sentiment']['score']:.2f})")
        print(f"Sentiment global: {news['global_sentiment']['label']} ({news['global_sentiment']['score']:.2f})")
