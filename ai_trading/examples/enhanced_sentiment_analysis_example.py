...
def main():
    ...
    os.makedirs(os.path.join(os.path.dirname(os.path.dirname(__file__)), "info_retour/data/sentiment"), exist_ok=True)
    os.makedirs(os.path.join(os.path.dirname(os.path.dirname(__file__)), "info_retour/data/sentiment/raw"), exist_ok=True)
    os.makedirs(os.path.join(os.path.dirname(os.path.dirname(__file__)), "info_retour/data/sentiment/analyzed"), exist_ok=True)
